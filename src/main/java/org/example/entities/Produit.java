...
@Entity
@NamedQuery(query = "SELECT p FROM Produit p WHERE p.categorieByIdCategorie.nomCat = :tata AND p.prixP > :titi", name = "toto")
@NamedNativeQuery(query = "SELECT * FROM produit WHERE idCategorie = ? AND prixP > ?", name = "sqlNatif")
